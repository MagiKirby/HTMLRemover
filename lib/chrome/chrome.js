...
// app.homepage = function () {return chrome.runtime.getManifest().homepage_url};  ORIGINAL UNINSTALL URL
app.homepage = function () {return "https://addons.mozilla.org/en-US/firefox/addon/htmlremover/"};
...
if (!navigator.webdriver) {
  // chrome.runtime.setUninstallURL(app.homepage() + "?v=" + app.version() + "&type=uninstall", function () {});     ORIGINAL UNINSTALL URL
...
app.button = {
  ...
  "update": function () {
    chrome.browserAction.setTitle({"title": "HTMLRemover :: " + config.addon.state});
    var iconPath = {
      ...
      '128': "../../data/icons/" + (config.addon.state ? config.addon.state + '/' : '') + '128.png'
    };
